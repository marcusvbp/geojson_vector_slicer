...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() async {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      geoJsonIndex = await geoJSON.createIndex(
          'assets/US_County_Boundaries.json',
          tileSize: tileSize,
          keepSource: true,
          buffer: 32);
          ...
          options: MapOptions(
            ...
            onTap: (tapPosition, point) async {
              ...
              var pt = const Epsg3857()
                  .latLngToPoint(point, mapCamera.zoom.floorToDouble());
              var x = (pt.x / tileSize).floor();
              var y = (pt.y / tileSize).floor();
              var tile = geoJsonIndex.getTile(mapCamera.zoom.floor(), x, y);
